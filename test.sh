...
echo "########################################## tests/test_R.sqlite3"
touch tests/test_R.sqlite3 
./target/release/firefox_bookmark_to_csv -d tests/test_R.sqlite3 -i tests/bookmarks.json -c tests/v1.csv -o /dev/shm/$_PROJ/bookmarks.csv
